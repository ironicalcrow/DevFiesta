...
class ProjectController {
  ...
  static async createProjectForTeam(req, res) {
    try {
      const { project_name, git_repo, overview, motivation, features, project_genre, team_id,demo_link } = req.body;
      console.log(req.body)

      const projectData = { project_name, git_repo, overview, motivation, features, project_genre,demo_link };
