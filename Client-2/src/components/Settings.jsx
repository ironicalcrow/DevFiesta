...
const SettingsPage = () => {
    ...
    const [image, setImage] = useState(User.imageUrl?User?.imageUrl:`https://placehold.co/96x96/E2E8F0/4A5568?text=${User?.full_name[0].toUpperCase() + User?.full_name[1].toUpperCase()}`);
                        ...
                        <section className="w-full lg:w-3/5 xl:w-2/3">
                            <form onSubmit={handleSubmit} className="max-w-4xl">
                                ...
                                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-8">
                                    <InputField label="Fullname" value={User?.full_name} />
                                ...
                                <div className="mt-12 flex items-center gap-4">
                                    <button type="submit" className="bg-[#6D8EF2] text-white font-semibold py-3 px-8 rounded-lg hover:bg-blue-700 transition-colors duration-200 text-lg">
                                        Save changes
                                    </button>
