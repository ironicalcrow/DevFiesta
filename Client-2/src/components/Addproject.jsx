                ...
                <form onSubmit={handleFormSubmit} className="max-w-5xl mx-auto flex flex-col gap-8">
                    ...
                    <section className="bg-white p-8 rounded-xl shadow-lg">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 mb-5">
                            ...
                            <button type="button" onClick={openRepo} className="w-full sm:w-auto bg-[#6D8EF2] text-white font-semibold py-4 px-6 rounded-lg hover:bg-gray-900 transition-colors duration-200 flex-shrink-0 text-lg">Open</button>
                        </div>
                        <button type="button" onClick={() => alert('Show contribution and stats popup (demo)!')} className="bg-gray-200 text-gray-800 font-semibold py-3 px-5 rounded-lg hover:bg-gray-300 transition-colors duration-200 text-lg">See contribution and stats</button>
                    </section>
                    ...
                    <section className="bg-white p-8 rounded-xl shadow-lg">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mb-5">
                            ...
                            <button type="button" onClick={addFeature} className="w-full sm:w-auto bg-[#6D8EF2] text-white font-semibold py-4 px-6 rounded-lg hover:bg-blue-700 transition-colors duration-200 flex-shrink-0 text-lg">Add</button>
                        </div>
                    ...
                    <div className="flex justify-center mt-6">
                        <button type="submit" className="w-full md:w-1/2 lg:w-1/3 bg-[#6D8EF2] hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-lg text-xl transition-transform transform hover:scale-105 duration-300">Submit Project</button>
                    </div>
                </form>
            </main>
        </div>
