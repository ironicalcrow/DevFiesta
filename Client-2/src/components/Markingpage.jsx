        ...
        <div className=" min-h-screen font-sans">
            <header className="bg-[#6D8EF2] shadow-md">
                <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    <h1 className="text-4xl font-bold text-gray-900">Project Judging</h1>
                    <p className="text-lg text-gray-600 mt-1">Review and score the submissions for {hackathonData.hackathonName}.</p>
                </div>
            </header>
