        ...
        <div className="bg-[#E9F0FF] min-h-screen font-sans">
            <header className="bg-[#6D8EF2] text-white py-16 sm:py-20 lg:py-24">
                <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold"> Explore Projects and enhance your Imaginations </h1>
                </div>
            </header>
            ...
            <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                <div className="relative flex items-center mb-10">
                    ...
                    />
                    <button className="ml-4 bg-[#4060C1] text-white font-semibold py-4 px-8 rounded-xl hover:bg-blue-700 text-lg">Search</button>
                </div>
                ...
                <div className="lg:grid lg:grid-cols-4 lg:gap-12">
                    ...
                    <main className="lg:col-span-3">
                        <div className="flex flex-col sm:flex-row justify-between items-center border-b border-gray-200 pb-5 mb-8">
                            <p className="text-base text-gray-600 mb-4 sm:mb-0">Showing {hackathonnum} Projects</p>
